        ...
        <>
            <div className='card1 d-flex flex-row'>
                <div className='card21'>
                    ...
                    <input type="text" value={email} className='inputbox' onChange={(e) => setEmail(e.target.value)} placeholder='   Enter Your Email Address' required/><br />
                    {email !== "" ? 
                    <Link to='regester'>
                        <button className='button1'>Submit</button>
                    </Link>: <button className='button1'>Submit</button>
                    }
